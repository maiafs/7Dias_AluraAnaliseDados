# -*- coding: utf-8 -*-
"""Alura Dia 5 - BOXPLOT.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1qzF0EJjvOzbxlePeTM62pJJ3TP7ZSYz0
"""
...
#Função para gerar o Boxplot por cada ano
def gerar_boxplot(emprestimos_completo, tipo_usuario):
    plt.figure(figsize=(10, 6))
    sns.boxplot(x='ano', y='contagem', data=df[df['tipo_vinculo_usuario'] == tipo_usuario])
    plt.title(f'Boxplot de Empréstimos Mensais por Ano para {tipo_usuario.capitalize()}')
    plt.xlabel('Ano')
    plt.ylabel('Contagem de Empréstimos Mensais')
    plt.show()

# Gera o boxplot para alunos de graduação
gerar_boxplot(contagem_emprestimos, 'graduacao')

# Gera o boxplot para alunos de pós-graduação
gerar_boxplot(contagem_emprestimos, 'pos_graduacao')